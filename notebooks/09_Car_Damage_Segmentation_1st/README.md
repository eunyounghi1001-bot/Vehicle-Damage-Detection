...
1. YOLO 코드 분석
   ...
   - 장점:
      - Standard Benchmark 방식: PASCAL VOC나 Cityscapes 챌린지 등에서 사용하는 가장 정확한(Global) mIoU 계산 방식. 배치 크기와 상관없이 항상 동일한 결과가 나옴
...
모델이 예측한 객체들의 신뢰도 점수 분포. **0~9점(0.1 미만) 구간의 비율이 매우 높음**을 확인
